...
// MATERIALS
const SColor _color_gold(                    0xFFFFF0A0); // ARGB(255, 255, 240, 160);
const SColor _color_stone(                   0xFFBEBEAF); // ARGB(255, 190, 190, 175);
const SColor _color_wood(                    0xFFC8BE8C); // ARGB(255, 200, 190, 140);
...
// Map maker stuff added for other gamemodes. LoadChallengePNG.as ect.
...
const SColor color_yes(0xFFfec6f);