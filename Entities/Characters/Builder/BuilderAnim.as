...
void onTick(CSprite@ this)
{
	...
	const bool action2 = blob.isKeyPressed(key_action2)||blob.isKeyPressed(key_pickup);
...
void onRender(CSprite@ this)
{
	...
	if (this.isAnimation("strike"))
	{
		...
		if (aimblob !is null)
		{
			Vec2f dimensions;
			GUI::SetFont("menu");
			GUI::GetTextDimensions(aimblob.getInventoryName(), dimensions);
			GUI::DrawText(aimblob.getInventoryName(), getDriver().getScreenPosFromWorldPos(aimblob.getPosition() - Vec2f(0, -aimblob.getHeight() / 2)) - Vec2f(dimensions.x / 2, -8.0f), color_white);		
		}
	}
}
