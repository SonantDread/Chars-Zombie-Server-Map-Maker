...
void onInit(CBlob@ this)
{
	...
	{
		ShopItem@ s = addShopItem(this, "twostararcheruniform", "$twostararcheruniform$", "twostararcheruniform", "Upgraded archer class", false);
		AddRequirement(s.requirements, "blob", "onestararcheruniform", "onestararcheruniform", 2);
	}
	{
		ShopItem@ s = addShopItem(this, "threestararcheruniform", "$threestararcheruniform$", "threestararcheruniform", "Upgraded archer class", false);
		AddRequirement(s.requirements, "blob", "twostararcheruniform", "twostararcheruniform", 2);
	}
}
